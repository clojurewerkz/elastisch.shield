...
(let [conn (fx/connect-rest)]
  (deftest ^{:rest true :query true} test-span-first-query
    ...
    ;; [[clojurewerkz.elastisch.shield.fixtures/person-jack]]) requires searching for
  ...
  (deftest ^{:rest true :query true} test-span-near-query
    ...
    ;; “documents” (which is what [[clojurewerkz.elastisch.shield.fixtures/article-on-elasticsearch]])
    ;; *actually* contains).
